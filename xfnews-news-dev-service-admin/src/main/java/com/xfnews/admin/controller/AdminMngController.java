...
import com.xfnews.admin.service.AdminUserService;
import com.xfnews.api.BaseController;
import com.xfnews.api.controller.admin.AdminMngControllerApi;
import com.xfnews.api.controller.user.HelloControllerApi;
import com.xfnews.enums.FaceVerifyType;
...
import com.xfnews.pojo.bo.AdminLoginBO;
import com.xfnews.pojo.bo.NewAdminBO;
import com.xfnews.utils.FaceVerifyUtils;
...
public class AdminMngController extends BaseController implements AdminMngControllerApi {
    ...
    public GraceJSONResult adminFaceLogin(AdminLoginBO adminLoginBO,
        ...
        String fileServerUrlExecute
                = "http://files.xfnewsnews.com:8004/fs/readFace64InGridFS?faceId=" + adminFaceId;

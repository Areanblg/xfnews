        ...
        <div class="white-bar">
            <div class="left-part">
                <div class="logo-wrapper" @click="goIndex()">
                    <!-- <img src="./img/xfnews-logo.png" class="big-logo"/> -->
                    <img src="../img/xfnews-logo.png" class="big-logo"/>
                </div>
                ...
                <div class="menus">
                    ...
                    <div class="single-default">
                        <a href="https://class.xfnews.com/sale/javaarchitect" target="_blank" class="white-header-left">架构师</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="detail-really">
            ...
            <div class="left-social">
                ...
                <div class="xfnews-words">
                    <span class="xfnews-num">xfnews</span>
                </div>

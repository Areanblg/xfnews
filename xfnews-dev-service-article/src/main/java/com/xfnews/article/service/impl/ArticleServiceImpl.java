...
import com.xfnews.api.config.RabbitMQConfig;
import com.xfnews.api.config.RabbitMQDelayConfig;
import com.xfnews.api.service.BaseService;
import com.xfnews.article.mapper.ArticleMapper;
import com.xfnews.article.mapper.ArticleMapperCustom;
import com.xfnews.article.service.ArticleService;
import com.xfnews.enums.ArticleAppointType;
import com.xfnews.enums.ArticleReviewLevel;
...
import com.xfnews.pojo.Category;
import com.xfnews.pojo.bo.NewArticleBO;
import com.xfnews.utils.DateUtil;
import com.xfnews.utils.PagedGridResult;
import com.xfnews.utils.extend.AliTextReviewUtils;
...
//        doDeleteArticleHTML(articleId);
    ...
    private void doDeleteArticleHTML(String articleId) {
        String url = "http://html.xfnewsnews.com:8002/article/html/delete?articleId=" + articleId;
